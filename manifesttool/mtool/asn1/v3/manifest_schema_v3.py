...
# (last modified on 2021-04-18 15:41:40.457267)
...
Manifest.componentType = namedtype.NamedTypes(
    ...
    namedtype.NamedType('payload-format', univ.Enumerated(namedValues=namedval.NamedValues(('raw-binary', 1), ('arm-patch-stream', 5), ('encrypted-raw', 257)))),
